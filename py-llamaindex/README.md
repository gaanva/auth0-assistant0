...
- [LlamaIndex](https://docs.llamaindex.ai/en/stable/) for building agentic workflows with `FunctionAgent`.
...
- `backend/` contains the backend code for the Web app and API written in Python using FastAPI and LlamaIndex.
